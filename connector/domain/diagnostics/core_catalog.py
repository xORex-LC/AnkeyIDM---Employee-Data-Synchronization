...
def build_core_catalog(*, strict: bool) -> ErrorCatalog:
    ...
    entries = [
        ...
        CatalogEntry(
            "SOURCE_DSL_SPEC_INVALID",
            SystemErrorCode.DATA_INVALID,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
            "SOURCE_DSL_LOCATION_INVALID",
            SystemErrorCode.DATA_INVALID,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
            "MAP_DSL_SPEC_INVALID",
            SystemErrorCode.DATA_INVALID,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
            "MAP_DSL_COMPILE_INVALID",
            SystemErrorCode.INTERNAL_ERROR,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
            "NORMALIZE_DSL_SPEC_INVALID",
            SystemErrorCode.DATA_INVALID,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
            "NORMALIZE_DSL_COMPILE_INVALID",
            SystemErrorCode.INTERNAL_ERROR,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
            "ENRICH_DSL_SPEC_INVALID",
            SystemErrorCode.DATA_INVALID,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
            "ENRICH_DSL_TEMPLATE_INVALID",
            SystemErrorCode.DATA_INVALID,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
            "ENRICH_DSL_COMPILE_INVALID",
            SystemErrorCode.INTERNAL_ERROR,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
            "ENRICH_DSL_LOOKUP_PROVIDER_MISSING",
            SystemErrorCode.DATA_INVALID,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
            "ENRICH_DSL_LOOKUP_KEY_OP_FAILED",
            SystemErrorCode.DATA_INVALID,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
            "ENRICH_DSL_MERGE_POLICY_INVALID",
            SystemErrorCode.DATA_INVALID,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
            "DICT_DSL_REGISTRY_INVALID",
            SystemErrorCode.DATA_INVALID,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
            "DICT_DSL_SPEC_INVALID",
            SystemErrorCode.DATA_INVALID,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
            "DICT_SOURCE_READ_FAILED",
            SystemErrorCode.IO_ERROR,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
            "DICT_SOURCE_MANIFEST_MISSING",
            SystemErrorCode.DATA_INVALID,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
            "DICT_SOURCE_MANIFEST_INVALID",
            SystemErrorCode.DATA_INVALID,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
            "DICT_SOURCE_FINGERPRINT_MISMATCH",
            SystemErrorCode.DATA_INVALID,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
        ...
        CatalogEntry(
            "DICT_RUNTIME_INIT_FAILED",
            SystemErrorCode.INTERNAL_ERROR,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
            "VALIDATE_DSL_SPEC_INVALID",
            SystemErrorCode.DATA_INVALID,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
            "MATCH_DSL_SPEC_INVALID",
            SystemErrorCode.DATA_INVALID,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
            "MATCH_DSL_COMPILE_INVALID",
            SystemErrorCode.INTERNAL_ERROR,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
            "RESOLVE_DSL_SPEC_INVALID",
            SystemErrorCode.DATA_INVALID,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
            "RESOLVE_DSL_COMPILE_INVALID",
            SystemErrorCode.INTERNAL_ERROR,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
        ...
        CatalogEntry(
            "CACHE_DSL_REGISTRY_INVALID",
            SystemErrorCode.CACHE_ERROR,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
            "CACHE_DSL_SPEC_INVALID",
            SystemErrorCode.CACHE_ERROR,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
        ...
        CatalogEntry(
            "CACHE_DSL_DEP_MISSING",
            SystemErrorCode.CACHE_ERROR,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
            "CACHE_DSL_HASH_MISMATCH",
            SystemErrorCode.CACHE_ERROR,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
            "CACHE_SCHEMA_ENSURE_FAILED",
            SystemErrorCode.CACHE_ERROR,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
            "CACHE_SCHEMA_REBUILD_FAILED",
            SystemErrorCode.CACHE_ERROR,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
        ...
        CatalogEntry(
            "settings.unknown_key", SystemErrorCode.DATA_INVALID, severity=None
        ),
        CatalogEntry(
            "ENRICH_FATAL_POLICY_UNSET",
            SystemErrorCode.INTERNAL_ERROR,
            severity=DiagnosticSeverity.WARNING,
        ),
        CatalogEntry(
            "ENRICH_MULTI_TARGET_UNSUPPORTED",
            SystemErrorCode.INTERNAL_ERROR,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
        ...
        CatalogEntry(
            "VAULT_STARTUP_KEY_CONFIG_ERROR",
            SystemErrorCode.INTERNAL_ERROR,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
            "VAULT_STARTUP_KEY_VALIDATION_ERROR",
            SystemErrorCode.INTERNAL_ERROR,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
            "VAULT_STARTUP_PROBE_CORRUPTED",
            SystemErrorCode.INTERNAL_ERROR,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
            "VAULT_STARTUP_STORAGE_READONLY",
            SystemErrorCode.INTERNAL_ERROR,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
            "VAULT_STARTUP_UNINITIALIZED_READONLY",
            SystemErrorCode.INTERNAL_ERROR,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
            "INVALID_JSON", SystemErrorCode.IO_ERROR, severity=DiagnosticSeverity.ERROR
        ),
        CatalogEntry(
            "INVALID_ITEMS_FORMAT",
            SystemErrorCode.IO_ERROR,
            severity=DiagnosticSeverity.ERROR,
        ),
        CatalogEntry(
        ...
        CatalogEntry(
            "SINK_IO_ERROR", SystemErrorCode.IO_ERROR, severity=DiagnosticSeverity.ERROR
        ),
        CatalogEntry(
            "SINK_UNAVAILABLE",
            SystemErrorCode.INFRA_UNAVAILABLE,
        ...
        CatalogEntry(
            "SINK_CONFLICT", SystemErrorCode.CONFLICT, severity=DiagnosticSeverity.ERROR
        ),
    ]
